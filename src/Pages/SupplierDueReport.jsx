...
const SupplierDueReport = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        setSuppliers(response.data);
        calculateTotals(response.data);
        toast.success("Suppliers filtered successfully!", {
          position: "top-center",
        });
      } catch (error) {
        toast.error(
          error.response?.data?.message || "Failed to filter suppliers",
          {
            position: "top-center",
          }
        );
  ...
  const calculateTotals = (suppliersData) => {
    const totalAmount = suppliersData.reduce(
